...
public class ProductImageApi {
	...
	public void uploadImage(
			...
			@ApiIgnore MerchantStore merchantStore, @ApiIgnore Language language) throws IOException, ServiceException {
	...
	public void deleteImage(@PathVariable Long id, HttpServletRequest request, HttpServletResponse response)
		...
		if (productImage == null) {
			throw new ResourceNotFoundException("No ProductImage found for ID : " + id);
		}
	...
	public void imageDetails(@PathVariable Long id, @PathVariable Long imageId,
		...
		if (p == null || p.getMerchantStore().getId().intValue() != merchantStore.getId().intValue()) {
